...
public class ArchFond extends com.htsoft.core.model.BaseModel {
	...
	@Expose
	protected java.util.Set<com.htsoft.oa.model.arch.ArchRoll> archRolls = new java.util.HashSet();
	@Expose
	protected java.util.Set<com.htsoft.oa.model.arch.BorrowFileList> borrowFileList = new java.util.HashSet();

	public java.util.Set getBorrowFileList() {
		return borrowFileList;
	}

	public void setBorrowFileList(java.util.Set<com.htsoft.oa.model.arch.BorrowFileList> borrowFileList) {
