...
/**
 * OutMail Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
...
public class OutMail extends com.htsoft.core.model.BaseModel {
	...
	public void setOutMailFolder (com.htsoft.oa.model.communicate.OutMailFolder in_outMailFolder) {
	...
	public void setFolderId(Long aValue) {
	    if (aValue==null) {
	        ...
	        outMailFolder = new com.htsoft.oa.model.communicate.OutMailFolder(aValue);
