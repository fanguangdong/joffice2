...
Ext.extend(Ext.ECalendar.dayview, Ext.util.Observable, {
	...
	header:true,
	headerFormat:'星期l - d - F  - Y',	// according to Ext.Date object 
	headerButtons: true,
	...
	task_format:'Y-m-d H:i:s', 	// added on 0.0.4 
		...
		if ( counttasks>0 ){ 
			...
			for (var i=0; i<Tasktohandle.length; i++){
					...
					if (tmpdescription.length>this.calx.tipmaxLength){ 
						tmpdescriptionx = tmpdescription.substring(0,this.calx.tipmaxLength) + '...'; 
					}
