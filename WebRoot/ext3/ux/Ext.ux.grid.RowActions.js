 ...
 * @date 22. March 2008
 * @version $Id: Ext.ux.grid.RowActions.js,v 1.1 2010/10/06 07:18:13 administrator Exp $
 * 
...
Ext.extend(Ext.ux.grid.RowActions, Ext.util.Observable, {
	...
	init : function(grid) {
		...
		if (view.groupTextTpl && this.groupActions) {
			view.interceptMouse = view.interceptMouse
		...
		Ext.each(actions, function(a, i) {
			...
			var o = {
				cls : a.iconIndex ? '{' + a.iconIndex + '}' : (a.iconCls
						? a.iconCls
						: ''),
				qtip : a.qtipIndex ? '{' + a.qtipIndex + '}' : (a.tooltip
						|| a.qtip ? a.tooltip || a.qtip : ''),
				text : a.textIndex ? '{' + a.textIndex + '}' : (a.text
						? a.text
						: ''),
				hide : a.hideIndex ? '<tpl if="'
						+ a.hideIndex
						+ '">'
						+ ('display' === this.hideMode
								? 'display:none'
								: 'visibility:hidden') + ';</tpl>' : (a.hide
						? ('display' === this.hideMode
								? 'display:none'
								: 'visibility:hidden;')
						: ''),
