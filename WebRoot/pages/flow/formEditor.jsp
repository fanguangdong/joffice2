...
<%@page import="com.htsoft.oa.service.flow.FormTemplateService"%>
...
<%@page import="com.htsoft.oa.model.flow.FormDef"%><html>
	<head>
		...
		if(!"undefined".equals(templateId) && StringUtils.isNotEmpty(templateId)){
			FormTemplateService formTemplateService=(FormTemplateService)AppUtil.getBean("formTemplateService");
			FormTemplate formTemplate=formTemplateService.get(new Long(templateId));
			if(StringUtils.isNotEmpty(formTemplate.getTempContent())){
				projectData=formTemplate.getExtDef();
			}
		}
		%>
