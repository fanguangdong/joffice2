...
<%@ page import="com.htsoft.oa.model.system.GlobalType,com.htsoft.oa.service.system.GlobalTypeService" %>
<%@ page import="com.htsoft.oa.model.flow.ProDefinition,com.htsoft.oa.service.flow.ProDefinitionService" %>
<%@ page import="com.htsoft.core.jbpm.jpdl.JpdlConverter" %>
<%@ page import="org.dom4j.Element" %>
<%@ page import="com.htsoft.oa.service.bpm.ILog.factory.BpmFactory" %>
<%
